...
<head>
  ...
  <link rel="short icon" href="./../../area-cliente/visual/imgs/logo.png" />
  <!-- Bootstrap -->
      ...
      <div class="col-md-10 mx-auto col-lg-5">
        <form class="p-4 p-md-5 border rounded-3 bg-body-tertiary" method="post" action="processLogin.php">
          <div class="form-floating mb-3">
            <input type="text" name="emailUsuario" class="form-control" id="floatingInput" placeholder="name@example.com">
            <label for="floatingInput">Email</label>
          </div>
          <div class="form-floating ">
            <input type="password" name="senhaUsuario" class="form-control" id="floatingPassword" placeholder="Password">
