    ...
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <div class="dropdown text-end">
        <a href="#" class="text-white d-block link-body-emphasis text-decoration-none dropdown-toggle"
          ...
          <img id="preview" src="../../img/Usuario/<?=$authUsuario['img']!="" ? $authUsuario['img']: 'padrao.jpg';?>" alt="..." alt="mdo" width="60" height="60" class="rounded-circle">
        </a>
        <ul class="dropdown-menu text-small">
          <li><a class="dropdown-item fw-bold" ><?=$authUsuario['nome']?></a></li>
          <li>
